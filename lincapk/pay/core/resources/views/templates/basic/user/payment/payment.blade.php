                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-3 preview-details d-nonee">
                                    <ul class="list-group list-group-flush text-center">
                                        ...
                                        <li class="list-group-item px-0 d-flex justify-content-between">
                                            <span class="fw-bold">@lang('Payment in') {{ __($general->cur_text) }}</span>
                                            <span class="fw-bold">{{ showAmount($sendMoney->base_currency_amount + $sendMoney->base_currency_charge) }}
                                                {{ __($general->cur_text) }}</span>
                                        </li>
                                        <li class="list-group-item px-0 d-flex d-none charge-data justify-content-between">
                                            <span class="fw-bold">@lang('Charge')</span>
                                            <span class=" fw-bold"><span class="charge">0</span> {{ __($general->cur_text) }}</span>
                                        </li>
                                        <li class="list-group-item px-0 d-flex d-none payable-data justify-content-between">
                                            <span class="fw-bold">@lang('Payable')</span> <span class="fw-bold"><span class="payable ">
                                                    0</span>
                                                {{ __($general->cur_text) }}</span>
                                        </li>
                                        <li class="list-group-item px-0 d-flex d-none limit-data justify-content-between">
                                            <span class="fw-bold">@lang('Limit')</span>
                                            <span class="fw-bold"><span class="min">0</span> {{ __($general->cur_text) }} - <span class="max ">0</span> {{ __($general->cur_text) }}</span>
                                        </li>
                                        ...
                                        <li class="list-group-item px-0 justify-content-center crypto_currency d-none">
                                            <span>@lang('Conversion with') <span class="method_currency"></span> @lang('and final value will Show on next
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    step')</span>
                                        </li>
                                    </ul>
                                </div>
