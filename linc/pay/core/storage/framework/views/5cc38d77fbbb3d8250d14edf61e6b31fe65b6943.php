...
<?php if($customCaptcha): ?>
    ...
    <div class="col-12 mb-3">
        <label class="<?php echo e($class); ?>"><?php echo app('translator')->get('Captcha'); ?></label>
...
<?php if($googleCaptcha): ?>
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH /home/u595814445/domains/linc.cd/public_html/platform/core/resources/views/partials/captcha.blade.php ENDPATH**/ ?>