...
<!-- Hero  -->
<section class="hero" style="background-image: url('<?php echo e(getImage('assets/images/frontend/banner/' . @$banner->data_values->image, '1800x840')); ?>')">
            ...
            <div class="row gy-5 g-lg-4 align-items-center justify-content-center justify-content-lg-between">
                <div class="col-lg-7 col-xxl-6 text-lg-start text-center">
                    ...
                    <p class="hero__content-para text--white ms-lg-0 mx-auto">
                        <?php echo e(__($banner->data_values->description)); ?>

                    </p>

                    <div class="hero__btn-group justify-content-center justify-content-lg-start mt-4">
                        <a href="<?php echo e($banner->data_values->button_link); ?>" class="btn btn--xl btn--base">
                            <?php echo e(__($banner->data_values->button_text)); ?>

                        </a>
                        <a href="<?php echo e($banner->data_values->youtube_link); ?>" class="btn btn--video btn--circle btn--base show-video">
                ...
                <div class="col-sm-10 col-lg-5 col-xxl-4">
                    <div class="exchange-form__header">
                        <span class="exchange-form__sub-title text--white"> <?php echo app('translator')->get('Conversion Rate'); ?> </span>
                    ...
                    <div class="exchange-form">
                        <form class="row g-0" action="<?php echo e(route('currency.calculator')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="col-12">
                                <div class="exchange-form__body">
                                    <div class="row g-3">
                                        <div class="col-12">
                                            <label for="from" class="text--accent sm-text d-block fw-md mb-2"><?php echo app('translator')->get('You Send'); ?></label>
                                        ...
                                        <div class="col-12">
                                            <label for="you-get" class="text--accent sm-text d-block fw-md mb-2"><?php echo app('translator')->get('Recipient Gets'); ?></label>
                                            <div class="input-group recipient-parent">
                                                ...
                                                <select class="recipient-countries country-picker" name="recipient_country" id="recipient-country" required>
                                                    <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($country->id); ?>"
                                                                <?php if($loop->index == 1): ?> selected <?php endif; ?>
                                                                data-id="<?php echo e($country->id); ?>"
                                                                data-currency="<?php echo e($country->currency); ?>"
                                                                data-rate="<?php echo e($country->rate); ?>"
                                                ...
                                                <li class="list__item timeline-list__item">
                                                    ...
                                                    <div class="timeline-list__content justify-content-between">
                                                        <div class="timeline-list__left">
                                                            <span class="d-block sm-text"><?php echo app('translator')->get('CHARGE'); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u595814445/domains/linc.cd/public_html/platform/core/resources/views/templates/basic/sections/banner.blade.php ENDPATH**/ ?>