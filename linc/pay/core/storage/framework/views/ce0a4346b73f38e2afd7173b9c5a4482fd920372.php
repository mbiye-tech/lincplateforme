                        ...
                        <div class="card custom--card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label class="d-block sm-text mb-2"><?php echo app('translator')->get('Setup Key'); ?></label>
                        ...
                        <div class="card custom--card">
                            ...
                            <form action="<?php echo e(route('user.twofactor.disable')); ?>" method="POST">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label class="d-block sm-text mb-2"><?php echo app('translator')->get('Google Authenticatior OTP'); ?></label>
...
<?php echo $__env->make($activeTemplate . 'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u595814445/domains/linc.cd/public_html/platform/core/resources/views/templates/basic/user/twofactor.blade.php ENDPATH**/ ?>