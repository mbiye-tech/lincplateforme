...
<div class="section ">
        ...
        <div class="row g-4 align-items-center">
            ...
            <div class="col-lg-6 col-xl-7">
                <div class="me-xxl-4">
                        ...
                        <img src="<?php echo e(getImage('assets/images/img/linc.png')); ?>" class="bounce" alt=""> 
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="hero-img" data-aos="zoom-out" data-aos-delay="200">
        ...
        <img src="<?php echo e(getImage('assets/images/img/about-removebg-preview.png')); ?>" alt="" class="img-fluid">
      </div>
        ...
        <div class="row content">
          <div class="col-lg-6">
            <p>
                ...
                <?php echo app('translator')->get('Trusting us is your guarantee when it comes to your transactions, so do not hesitate to open an account with us and make your transactions'); ?></p>
            <ul>
              <li><i class="ri-check-double-line"></i> <?php echo app('translator')->get('Available throughout the Democratic Republic of Congo and around the world'); ?></li>
              <li><i class="ri-check-double-line"></i><?php echo app('translator')->get('Linc vous offrez des services de qualité en ce qui concerne le mobile money et consort'); ?></li>
        ...
        <div class="row row-eq-height justify-content-center">
          ...
          <div class="col-lg-4 mb-4">
            <div class="card" data-aos="zoom-in" data-aos-delay="200">
              ...
              <div class="card-body">
                <h5 class="card-title">Effectuer le paiement</h5>
          ...
          <div class="col-lg-4 mb-4">
            <div class="card" data-aos="zoom-in" data-aos-delay="300">
              ...
              <div class="card-body">
                <h5 class="card-title">Le destinataire réçoit une notification</h5>
...
<?php /**PATH /home/u595814445/domains/linc.cd/public_html/pay/core/resources/views/templates/basic/sections/about.blade.php ENDPATH**/ ?>