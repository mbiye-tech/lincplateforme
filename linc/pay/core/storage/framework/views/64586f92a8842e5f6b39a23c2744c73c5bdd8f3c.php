			...
			<div class="container">
				<div class="row">
					<div class="col-lg-6 offset-lg-3 col-12">
						<div class="section-title bg">
							<h2> <?php echo app('translator')->get('How to receive money'); ?><span></span></h2>
							<p>.</p>
				...
				<div class="row">
					<div class="col-lg-5 col-12">
						<div class="event-img">
            <img src="<?php echo e(getImage('assets/images/img/HandCongolesefranc.png')); ?>" class="img-fluid" alt="">
						</div>
					</div>
						...
						<div class="coming-event">
							...
							<div class="single-event">
								...
								<div class="event-content">
									<h3 class="event-title"><a href=""> <?php echo app('translator')->get('Bank account'); ?></a></h3>
									<p><?php echo app('translator')->get('Recipients can receive funds directly into their bank accounts.'); ?></p>
							...
							<div class="single-event">
								...
								<div class="event-content">
									<h3 class="event-title"><a href="event-single.html"><?php echo app('translator')->get('Mobile wallet'); ?></a></h3>
									<p><?php echo app('translator')->get(' Mobile wallet is a fast and convenient way to send money directly to recipients phones.'); ?></p>
									<span class="entry-date-time"><i class="fa fa-clock-o" aria-hidden="true"></i></span>
								</div>
							</div>
							<!-- End Single Event -->
							...
							<div class="single-event">
								...
								<div class="event-content">
									<h3 class="event-title"><a href="event-single.html"><?php echo app('translator')->get('Canal alternatif'); ?></a></h3>
									<p><?php echo app('translator')->get('Beneficiaries can receive the tokens that will allow them to withdraw the funds without a card at ATMs.'); ?></p>
									<span class="entry-date-time"><i class="fa fa-clock-o" aria-hidden="true"></i></span>
								</div>
							</div>
							<!-- End Single Event -->
...
<?php /**PATH /home/u595814445/domains/linc.cd/public_html/pay/core/resources/views/templates/basic/sections/how_to_receive.blade.php ENDPATH**/ ?>