                    ...
                    <form action="<?php echo e(route('admin.language.store.key',$lang->id)); ?>" method="post">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="key" class="fw-bold"><?php echo app('translator')->get('Key'); ?></label>
                                <input type="text" class="form-control" id="key" name="key" value="<?php echo e(old('key')); ?>" required>

                            </div>
                            <div class="form-group">
                                <label for="value" class="fw-bold"><?php echo app('translator')->get('Value'); ?></label>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u595814445/domains/linc.cd/public_html/platform/core/resources/views/admin/language/edit_lang.blade.php ENDPATH**/ ?>