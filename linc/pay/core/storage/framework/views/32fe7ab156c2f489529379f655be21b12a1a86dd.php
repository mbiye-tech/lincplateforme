            ...
            <div class="card">
                <form action="" class="notify-form">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn w-100 h-45 btn--primary mr-2"><?php echo app('translator')->get('Submit'); ?></button>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u595814445/domains/linc.cd/public_html/pay/core/resources/views/admin/users/notification_all.blade.php ENDPATH**/ ?>