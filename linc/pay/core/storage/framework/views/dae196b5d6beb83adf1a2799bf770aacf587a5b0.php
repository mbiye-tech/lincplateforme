    ...
    <div class="custom--card mt-5">
        <div class="card-body">
            <div class="d-flex flex-wrap flex-row-reverse justify-content-between align-items-center mb-lg-3">
                <div class="text-end">
                    <a href="<?php echo e(route('agent.ticket.open')); ?>" class="btn btn-sm btn--base mb-2"> <i class="fa fa-plus"></i> <?php echo app('translator')->get('New Ticket'); ?></a>
                </div>
                <div class="">
                    <h6 class="text-lg-start m-0 text-center"><?php echo app('translator')->get('Support Ticket'); ?></h6>
                </div>
            </div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $supports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $support): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td data-label="<?php echo app('translator')->get('Action'); ?>">
                                    <a href="<?php echo e(route('agent.ticket.view', $support->ticket)); ?>" class="btn btn--base btn-sm">
...
<?php echo $__env->make('agent.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u595814445/domains/linc.cd/public_html/pay/core/resources/views/agent/support/index.blade.php ENDPATH**/ ?>