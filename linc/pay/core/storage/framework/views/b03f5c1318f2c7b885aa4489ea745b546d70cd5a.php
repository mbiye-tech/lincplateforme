                    ...
                    <div class="login-area">
                        <div class="login-wrapper">
                            <div class="login-wrapper__top">
                                ...
                                <p class="text-white"><?php echo e(__($pageTitle)); ?> <?php echo app('translator')->get('to'); ?> <?php echo e(__($general->site_name)); ?> <?php echo app('translator')->get('Dashboard'); ?></p>
                            </div>
                            <div class="login-wrapper__body">
                                <form action="<?php echo e(route('admin.login')); ?>" method="POST" class="cmn-form mt-30 verify-gcaptcha login-form">
                                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
                                    ...
                                    <button type="submit" class="btn cmn-btn h-45 w-100 mt-3"><?php echo app('translator')->get('LOGIN'); ?></button>
                                </form>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u595814445/domains/linc.cd/public_html/platform/core/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>