                ...
                <form action="" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-4 d-none configForm" id="mailjet">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="fw-bold"><?php echo app('translator')->get('Api Public Key'); ?> </label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="fw-bold"><?php echo app('translator')->get('Api Secret Key'); ?> </label>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u595814445/domains/linc.cd/public_html/platform/core/resources/views/admin/notification/email_setting.blade.php ENDPATH**/ ?>