        ...
        <div class="container">
            <?php if($class == 'header--primary'): ?>
                <a href="<?php echo e(route('home')); ?>" class="logo logo-dark">
                    <img src="<?php echo e(getImage(getFilepath('logoIcon') . '/linc.png')); ?>" alt="<?php echo e(__($general->site_name)); ?>" class="img-fluid logo__is" />
                </a>
            <?php endif; ?>
...
<!-- Header End -->
<?php /**PATH /home/u595814445/domains/linc.cd/public_html/pay/core/resources/views/templates/basic/partials/header.blade.php ENDPATH**/ ?>