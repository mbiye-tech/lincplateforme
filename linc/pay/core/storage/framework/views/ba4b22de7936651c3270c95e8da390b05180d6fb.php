				...
				<div class="row">
					<div class="col-lg-6 offset-lg-3 col-12">
						<div class="section-title bg">
							...
							<p>Linc vous permet d'envoyer de l'argent à vos amis et à votre famille à bas prix et de manière simple.</p>
    ...
    <div class="container">
        <div class="row gy-5 g-lg-4 align-items-center justify-content-center">
            <div class="col-lg-6 col-md-5 col-sm-10"> 
                <img src="<?php echo e(getImage('assets/images/img/linc.png')); ?>" alt="<?php echo e(__($general->site_name)); ?>" class="img-fluid">
            </div>
...
<!-- App Section End -->
<?php /**PATH /home/u595814445/domains/linc.cd/public_html/pay/core/resources/views/templates/basic/sections/app.blade.php ENDPATH**/ ?>