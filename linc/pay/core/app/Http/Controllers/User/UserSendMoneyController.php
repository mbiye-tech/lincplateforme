...
class UserSendMoneyController extends Controller
{
    ...
    public function sendMoney()
    {
        ...
        return view($this->activeTemplate . 'user.send_money.form', compact('pageTitle', 'countries', 'sources', 'purposes', 'sendingAmount', 'recipientAmount', 'sendingCountry', 'recipientCountry'));
    }
