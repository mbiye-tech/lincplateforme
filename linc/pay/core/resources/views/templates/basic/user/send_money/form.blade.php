            ...
            <div class="card custom--card">
                ...
                <form action="{{ route('user.send.money.save') }}" method="post"
                    ...
                    <input  class="form-control" name="recipient[address]" value="{{ old('recipient')['address'] ?? null }}" id="recipient_address" required>
                             ...
                             <div class="col">
                             <label for="recipient_name" class="text--accent sm-text d-block fw-md mb-2">@lang('Zip code')</label>
                ...
                <div class="row">
                        ...
                        <div class="col">
                          ...
                          <label for="recipient_name" class="text--accent sm-text d-block fw-md mb-2">@lang('Email')</label>
